...
class ReadConf(_Conf):
    def __init__(self, uri="bolt://localhost:7687", auth=("neo4j", "neo4j"),
        ...
        """
        self.uri = uri
        self.auth_username = auth[0]
        self.auth_password = auth[1]
    ...
    def __init__(self, batch_size=None, batch_buffer_size=None,
        ...
        """
            @param batch_size(int):
                ...
                spark.neo4j.output.batch.size.bytes if set.
            ...
            @param parallelism_level(int):
                ...
                spark.neo4j.output.concurrent.writes if set.
            ...
            @param timestamp(int, date or datetime):
                ...
                values.
                If None given the Neo4j nodes determine the timestamp.
